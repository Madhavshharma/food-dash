    ...
    <footer className="text-orange-900 py-8" style={{ backgroundColor: "#FFEFE6" }}>
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between">
        <div className="mb-8 md:mb-0 flex flex-col space-y-4">
          ...
          <p className="mt-2 text-gray-400">Food Dash ©2024 All Rights Reserved</p>
          <p className="text-gray-400">By: Mahendra Kumawat</p>
          <h1 className="font-bold text-2xl text-orange-500">Follow Us On</h1>
          <div className="flex  text-gray-500 space-x-5 mr-6 mt-6 mb-5">
            {/* Facebook */}
        ...
        <div className="flex flex-col md:flex-row md:space-x-12">
          <div className="mb-8 md:mb-0">
            <h1 className="font-bold text-2xl mb-5 text-orange-500">Menu</h1>
            <ul className="flex flex-col space-y-4">
              <li><a href="#" className="text-gray-400">Home</a></li>
              <li><a href="#" className="text-gray-400">Offers</a></li>
              <li><a href="#" className="text-gray-400">Service</a></li>
              <li><a href="#" className="text-gray-400">About Us</a></li>
            </ul>
          </div>
          <div className="mb-8 md:mb-0">
            <h2 className="font-bold text-2xl mb-5 text-orange-500">Information</h2>
            <ul className="flex flex-col space-y-4">
              <li><a href="#" className="text-gray-400">Menu</a></li>
              <li><a href="#" className="text-gray-400">Quality</a></li>
              <li><a href="#" className="text-gray-400">Make A Choice</a></li>
              <li><a href="#" className="text-gray-400">Fast Delivery</a></li>
            </ul>
          </div>
          <div>
            <h2 className="font-bold text-2xl mb-5 text-orange-500">Contact</h2>
            <ul className="flex flex-col space-y-4">
              <li><a href="#" className="text-gray-400">+123456789</a></li>
              <li><a href="#" className="text-gray-400">Explore</a></li>
              <li><a href="mailto:info@fooddash.com" className="text-gray-400">info@fooddash.com</a></li>
              <li><a href="#" className="text-gray-400">12, Maharashtra, India</a></li>
            </ul>
          </div>
        </div>
      </div>
